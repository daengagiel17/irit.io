    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- Portofolio --}}
          <li class="nav-item">
            <a href="{{ route('portofolio.index') }}" class="nav-link {{ request()->routeIs('portofolio*')?'active':'' }}">
          ...
          {{-- Testimoni --}}
          <li class="nav-item">
            <a href="{{ route('testimoni.index') }}" class="nav-link {{ request()->routeIs('testimoni*')?'active':'' }}">
              <i class="nav-icon far fa-grin-wink"></i>
              <p> Testimoni </p>
            </a>
          </li>
