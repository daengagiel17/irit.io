        ...
        <div class="row">
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('portofolio.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="waktu_pengerjaan" name="waktu_pengerjaan" placeholder="Enter Waktu Pengerjaan">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="gif" name="gif" placeholder="Enter Gif">
                  </div>
                  <div class="form-group">
