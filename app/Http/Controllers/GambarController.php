...
class GambarController extends Controller
{
    ...
    {
        $gambars = Gambar::where('portofolio_id', $portofolio_id)->get();

        return view('gambar.index', compact(['gambars', 'portofolio_id']));
    }
    ...
    {
        return view('gambar.create', compact(['portofolio_id']));
    }
    ...
    public function store(Request $request, $portofolio_id)
    {
        ...
        $dir = 'img/portofolio/' . $portofolio_id . '/';
        ...
        return redirect()->route('gambar.index', ["portofolio_id" => $portofolio_id]);
    }
